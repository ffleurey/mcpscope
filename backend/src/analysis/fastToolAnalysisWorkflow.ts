...
import { runFastToolPlanningStep } from './fastTool/fastToolPlanningStep.js'
import { runFastToolGroupedAssessmentTurn } from './fastTool/fastToolGroupedAssessmentTurn.js'
import { runFastToolFinalAggregationTurn } from './fastTool/fastToolFinalAggregationTurn.js'

function now(): number {
  return Date.now()
}

export type FastToolAnalysisWorkflowInput = AnalysisWorkflowInput
