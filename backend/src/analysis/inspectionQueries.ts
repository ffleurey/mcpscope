...
// SHORTCUT: this map bridges two parallel part-type vocabularies (persisted
// dashed `partTypeValues` vs the public underscored taxonomy in DATA-MODEL.md),
// accepting both spellings and silently defaulting unknowns to
// 'assistant_answer'. Paying this back = one canonical part-type enum used by
// persistence and the public taxonomy, with this bridge deleted.
