...
export const partContextSchema = z.object({
  ...
  note: z.string().nullable(),
  // Misnomer kept for trace-format compatibility: despite the name, the value
  // is a compaction STEP id (e.g. "AB12.2C" — DB column
  // stripped_by_compaction_at_step_id). Renaming would break every recorded
