 ...
 * repositoryCompat.ts
 *
 * Session/turn/round/part/rawexchange repository functions implemented against
 * the v2 database tables (v2_sessions, v2_steps, v2_turns, v2_rounds, v2_parts,
 * v2_raw_exchanges).  Exports the same function signatures as repository.ts so
