...
The master logo SVGs for mcpscope. The rules and rationale are canonical in
...
```bash
rsvg-convert -w 1000 docs/design-assets/logo.svg      -o docs/design-assets/logo.png
rsvg-convert -w 512 -h 512 docs/design-assets/logo-mark.svg -o docs/design-assets/logo-mark.png
```
