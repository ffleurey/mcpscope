...
- The names-only-vs-full-schema split (top-level finding #4) is most visible here:
  someone inspecting a setup in "full" mode reasonably expects the full tool schemas.
