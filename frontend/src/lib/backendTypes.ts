...
export const sessionInitStatusSchema = z.enum([
  "pending",
  "initializing",
  "ready",
  "error",
...
export const tokenConfidenceSchema = z.enum([
  "exact",
  "corrected",
  "estimated",
  "unknown",
...
export type SessionCreationDefaults = z.infer<
  typeof sessionCreationDefaultsSchema
>;
...
export type HierarchicalLookupResponse = z.infer<
  typeof hierarchicalLookupResponseSchema
>;
export type LaunchAnalysisResponse = z.infer<
  typeof launchAnalysisResponseSchema
>;
