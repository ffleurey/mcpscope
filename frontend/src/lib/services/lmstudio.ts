...
export async function loadModel(
  ...
  await loadLmConnectionModel(baseUrl, modelKey, apiKey ?? null, contextSize, providerType)
}
...
export async function unloadModel(
  ...
  await unloadLmConnectionModel(baseUrl, instanceId, apiKey ?? null, providerType)
}
