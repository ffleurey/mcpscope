            ...
            <tr>
              <td class="col-toggle">
                <button
                  ...
                  disabled={isBuiltin}
                  title={isBuiltin
                    ? 'Built-in servers are selected per session, not set as defaults'
              ...
              <td title={profile.name}>
                ...
                {#if isBuiltin}<span
                    class="tag"
                    title="Bundled companion server — managed by mcpscope, not editable"
                    >built-in</span
                  >{/if}
                {#if profile.disabledReason}<span class="tag tag-warn">needs API key</span>
                  <div class="profile-note">{profile.disabledReason}</div>{/if}
              </td>
              ...
              <td class="col-actions">
                <span class="row-actions">
                  ...
                  <button
                    class="icon-btn"
                    disabled={isBuiltin}
                    title={isBuiltin ? 'Built-in servers are not editable' : 'Edit'}
                    aria-label="Edit"
                  ...
                  <button
                    ...
                    disabled={isBuiltin}
                    title={isBuiltin ? 'Built-in servers cannot be removed' : 'Delete'}
                    aria-label="Delete"
...
<style>
  /* Small pill marking a bundled, read-only companion profile. */
  .tag {
  ...
  /* Warning-tinted variant marking a key-gated profile that is not yet configured. */
  .tag-warn {
