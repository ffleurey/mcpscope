...
<div class="ref-page">
  <header class="ref-header">
    ...
    <p class="ref-subtitle">
      ...
      components, not copied. See <span class="mono">docs/DESIGN-SYSTEM.md</span>
      for rationale and decisions.
    </p>
  </header>

  <!-- ─── LOGO ─────────────────────────────────────────────────────────── -->
  <section class="ref-section" id="logo">
    <h2>Logo</h2>
    <p class="ref-note">
      Master SVGs live in <code class="mono">docs/design-assets/</code>; the app serves copies from
  ...
  <section class="ref-section" id="buttons">
    ...
    <p class="ref-note">
      Default and Danger: transparent bg, accent border + text; hover adds a subtle tinted
      background. Primary: filled amber bg with dark text; hover lifts to <code class="mono"
        >--amber-glow</code
